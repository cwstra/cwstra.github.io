	...
	var i,s,img,prop,j,num,x; for (i=0;i<stars.length;i++){
		...
		if (planets[i]==={} && capturedPlanets=="No Captures"){
			...
			for (prop in planets[i]){if (planets[i].hasOwnProperty(prop)){
				...
				tabstr+='\t<table class="system"><tr><td></td><td>Planet Type:</td><td>'+planets[i][prop][2]+'</td><td rowspan="3" style="width:100;">'+planetImage(planets[i][prop][2])+'</td></tr>\n';
				...
				tabstr+='\t<tr><td></td><td>Orbital Distance:</td><td colspan="2">'+round(bode(planets[i][prop][0]),2)+' AU</td></tr>\n';
				...
				if (planets[i][prop][3].hasOwnProperty("Relative Humidity")){
					...
					tabstr+='\t<tr><td></td><td>Mean Planetary Temperature:</td><td colspan="2">'+planets[i][prop][3]["Mean Temperature"]+'&#2109;</td></tr>\n';
					tabstr+='\t<tr><td></td><td>Mean Temperature Range:</td><td colspan="2">'+planets[i][prop][3]["Mean Low Temperature"]+" to "+planets[i][prop][3]["Mean High Temperature"]+'&#2109;</td></tr>\n';
				}
			...
			if (capturedPlanets!="No Captures"){
				for (prop in capturedPlanets[i]){if (capturedPlanets[i].hasOwnProperty(prop)){
					tabstr+='\t<tr><td colspan="3"><button class="system">'+prop+'</button>\n';
					tabstr+='\t<table class="system"><tr><td></td><td>Planet Type:</td><td>'+capturedPlanets[i][prop][0]+'</td><td rowspan="3" style="width:100;">'+planetImage(capturedPlanets[i][prop][2])+'</td></tr>\n';
